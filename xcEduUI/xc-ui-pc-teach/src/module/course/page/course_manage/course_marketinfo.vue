  ...
  <div>
    <el-form :model="courseMarketForm" label-width="110px" :rules="courseMarketFormRules" ref="courseMarketForm">
      <el-form-item label="课程价格" prop="charge">
        ...
        <br/>
        <template v-if="this.courseMarketForm.charge == '203002'">
          金额（元）：
      ...
      <el-form-item label="有效期" v-if="this.courseMarketForm.valid == '204002'" style="width:500px;">
        <el-col :span="11">
          <el-date-picker type="date" placeholder="开始日期" v-model="courseMarketForm.startTime" style="width: 100%;"></el-date-picker>
        </el-col>
        <el-col class="line" :span="2">-</el-col>
        <el-col :span="11">
          <el-date-picker type="date" placeholder="结束日期" v-model="courseMarketForm.endTime" style="width: 100%;"></el-date-picker>
        </el-col>
      </el-form-item>
  ...
  export default {
    ...
    mounted() {
      ...
      systemApi.sys_getDictionary('203').then((res) => {
        ...
        this.courseMarketForm.charge = this.chargeList[0].sdId;
      });
      systemApi.sys_getDictionary('204').then((res) => {
        this.validList = res.dValue;
        this.courseMarketForm.valid = this.validList[0].sdId;
      });
