...
public class CmsPageService {
    ...
    public QueryResult<CmsPagePostLog> findLogs(String pageId) {
        List<CmsPagePostLog> logs = cmsPagePostLogRepository.findByPageId(pageId);
        QueryResult<CmsPagePostLog> result = new QueryResult<CmsPagePostLog>();
